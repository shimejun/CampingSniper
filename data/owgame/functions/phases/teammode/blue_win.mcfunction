...
execute if entity @e[tag=!team] run title @a subtitle [{"text":"Winner:","color":"gold","bold":true},{"text":"BLUE TEAM","color":"blue"}]
...
clear @a
tellraw @a [{"text":"Winner: ","color":"gold"},{"selector":"@a[team=blue]","color":"aqua"}]
scoreboard players add @a[team=blue] win_total 1
...
execute if score #teamtype id matches 2 run advancement grant @a[team=blue] only owgame:badges/team_duowin
execute if score #teamtype id matches 3 run advancement grant @a[team=blue] only owgame:badges/team_triowin
execute if score #teamtype id matches 4 run advancement grant @a[team=blue] only owgame:badges/team_quintwin
execute if score #teamtype id matches 6 run advancement grant @a[team=blue] only owgame:badges/team_hexawin
execute unless entity @a[team=blue,gamemode=spectator] run advancement grant @a[team=blue] only owgame:badges/team_win
...
execute if score #teamtype id matches 6 as @a[team=blue,gamemode=adventure] at @s unless entity @a[team=blue,distance=0.1..] run advancement grant @s only owgame:badges/team_solowin_in6team
