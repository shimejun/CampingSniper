...
execute as @a[team=blue,gamemode=adventure] at @s unless entity @a[team=blue,gamemode=adventure,distance=1..] run advancement grant @s only owgame:badges/team_clutch
