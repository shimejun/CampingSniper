...
execute if score #teamtype id matches 6 as @a[team=green,gamemode=adventure] at @s unless entity @a[team=green,distance=0.1..] run advancement grant @s only owgame:badges/team_solowin_in6team
