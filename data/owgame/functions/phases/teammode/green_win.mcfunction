...
execute as @a[team=green,gamemode=adventure] at @s unless entity @a[team=green,gamemode=adventure,distance=1..] run advancement grant @s only owgame:badges/team_clutch
