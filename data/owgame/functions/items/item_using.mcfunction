...
execute unless block ~ ~ ~ water run scoreboard players add @s[predicate=owgame:sneak,scores={health=..299},nbt={SelectedItem:{id:"minecraft:red_dye",tag:{bantage:1b}}}] syringe_time 1
execute unless block ~ ~ ~ water if block ~ ~1 ~ tinted_glass run scoreboard players add @s[scores={health=..299},nbt={SelectedItem:{id:"minecraft:red_dye",tag:{bantage:1b}}}] syringe_time 1
...
execute if entity @s[scores={syringe_time=1..},nbt={SelectedItem:{id:"minecraft:red_dye",tag:{bantage:1b}}},predicate=owgame:sneak] run experience add @s 10 points
execute if entity @s[scores={syringe_time=1..,sneak=10},nbt={SelectedItem:{id:"minecraft:red_dye",tag:{bantage:1b}}}] run experience add @s 10 points
