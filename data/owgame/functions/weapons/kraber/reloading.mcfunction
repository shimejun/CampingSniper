...
execute if score @s[scores={reload_sr=98}] ammo_sr matches 4 run scoreboard players set @s reload_sr 14
execute if score @s[scores={reload_sr=85}] ammo_sr matches 3 run scoreboard players set @s reload_sr 39
execute if score @s[scores={reload_sr=85}] ammo_sr matches 2 run scoreboard players set @s reload_sr 54
execute if score @s[scores={reload_sr=85}] ammo_sr matches 1 run scoreboard players set @s reload_sr 69
...
execute if score @s reload_sr matches 1 run scoreboard players set @s reload_sr 0

#アイテム置換
item replace entity @s[scores={reload_sr=0},nbt={SelectedItem:{id:"minecraft:stick"}}] weapon.mainhand with stick{sr_r:1b,reloading:0b,comsumable:1b,display:{Name:'[{"text":"スナイパーライフル","color":"gray"},{"text":" | ","color":"dark_gray"},{"text":"4/4","color":"gray"}]',Lore:['{"text":"Clip:4 Body:180 Head:450 Range:300m Reload:5s","color":"gray"}','{"text":"「火力(パワー)は全てを解決する！」","color":"gray","italic":true}','{"text":"圧倒的な攻撃力を誇るスナイパーライフル。"}','{"text":"右クリックでスコープを展開する。オフハンドに持ち替えることで射撃する。"}','{"text":"一定時間スニークすると伏せることもできる。伏せ状態はジャンプすると解除される。"}']},AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:-0.3,Operation:1,UUID:[I;1486144296,-749059616,-1921787441,642927478],Slot:"mainhand"}]}
item replace entity @s[scores={reload_sr=33},nbt={SelectedItem:{id:"minecraft:stick"}}] weapon.mainhand with stick{sr_r:1b,reloading:1b,comsumable:1b,display:{Name:'[{"text":"スナイパーライフル","color":"gray"},{"text":" | ","color":"dark_gray"},{"text":"4/4","color":"gray"}]',Lore:['{"text":"Clip:4 Body:180 Head:450 Range:300m Reload:5s","color":"gray"}','{"text":"「火力(パワー)は全てを解決する！」","color":"gray","italic":true}','{"text":"圧倒的な攻撃力を誇るスナイパーライフル。"}','{"text":"右クリックでスコープを展開する。オフハンドに持ち替えることで射撃する。"}','{"text":"一定時間スニークすると伏せることもできる。伏せ状態はジャンプすると解除される。"}']},AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:-0.3,Operation:1,UUID:[I;1486144296,-749059616,-1921787441,642927478],Slot:"mainhand"}]}
item replace entity @s[scores={reload_sr=48},nbt={SelectedItem:{id:"minecraft:stick"}}] weapon.mainhand with stick{sr_r:1b,reloading:1b,comsumable:1b,display:{Name:'[{"text":"スナイパーライフル","color":"gray"},{"text":" | ","color":"dark_gray"},{"text":"3/4","color":"gray"}]',Lore:['{"text":"Clip:4 Body:180 Head:450 Range:300m Reload:5s","color":"gray"}','{"text":"「火力(パワー)は全てを解決する！」","color":"gray","italic":true}','{"text":"圧倒的な攻撃力を誇るスナイパーライフル。"}','{"text":"右クリックでスコープを展開する。オフハンドに持ち替えることで射撃する。"}','{"text":"一定時間スニークすると伏せることもできる。伏せ状態はジャンプすると解除される。"}']},AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:-0.3,Operation:1,UUID:[I;1486144296,-749059616,-1921787441,642927478],Slot:"mainhand"}]}
item replace entity @s[scores={reload_sr=63},nbt={SelectedItem:{id:"minecraft:stick"}}] weapon.mainhand with stick{sr_r:1b,reloading:1b,comsumable:1b,display:{Name:'[{"text":"スナイパーライフル","color":"gray"},{"text":" | ","color":"dark_gray"},{"text":"2/4","color":"gray"}]',Lore:['{"text":"Clip:4 Body:180 Head:450 Range:300m Reload:5s","color":"gray"}','{"text":"「火力(パワー)は全てを解決する！」","color":"gray","italic":true}','{"text":"圧倒的な攻撃力を誇るスナイパーライフル。"}','{"text":"右クリックでスコープを展開する。オフハンドに持ち替えることで射撃する。"}','{"text":"一定時間スニークすると伏せることもできる。伏せ状態はジャンプすると解除される。"}']},AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:-0.3,Operation:1,UUID:[I;1486144296,-749059616,-1921787441,642927478],Slot:"mainhand"}]}
item replace entity @s[scores={reload_sr=78},nbt={SelectedItem:{id:"minecraft:stick"}}] weapon.mainhand with stick{sr_r:1b,reloading:1b,comsumable:1b,display:{Name:'[{"text":"スナイパーライフル","color":"gray"},{"text":" | ","color":"dark_gray"},{"text":"1/4","color":"gray"}]',Lore:['{"text":"Clip:4 Body:180 Head:450 Range:300m Reload:5s","color":"gray"}','{"text":"「火力(パワー)は全てを解決する！」","color":"gray","italic":true}','{"text":"圧倒的な攻撃力を誇るスナイパーライフル。"}','{"text":"右クリックでスコープを展開する。オフハンドに持ち替えることで射撃する。"}','{"text":"一定時間スニークすると伏せることもできる。伏せ状態はジャンプすると解除される。"}']},AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:-0.3,Operation:1,UUID:[I;1486144296,-749059616,-1921787441,642927478],Slot:"mainhand"}]}

#拳モード
execute if score #punch id matches 1 if score @s reload_sr matches 98 run scoreboard players set @s reload_sr 95
execute if score #punch id matches 1 if score @s reload_sr matches 88 run scoreboard players set @s reload_sr 82

execute if score #punch id matches 1 if entity @s[scores={reload_sr=78},nbt={SelectedItem:{id:"minecraft:stick"}}] run playsound minecraft:block.dispenser.fail block @s ~ ~ ~ 1 0.7
execute if score #punch id matches 1 if score @s reload_sr matches 78 run scoreboard players set @s reload_sr 65

execute if score #punch id matches 1 if entity @s[scores={reload_sr=63},nbt={SelectedItem:{id:"minecraft:stick"}}] run playsound minecraft:block.dispenser.fail block @s ~ ~ ~ 1 0.7
execute if score #punch id matches 1 if score @s reload_sr matches 63 run scoreboard players set @s reload_sr 50

execute if score #punch id matches 1 if entity @s[scores={reload_sr=48},nbt={SelectedItem:{id:"minecraft:stick"}}] run playsound minecraft:block.dispenser.fail block @s ~ ~ ~ 1 0.7
execute if score #punch id matches 1 if score @s reload_sr matches 48 run scoreboard players set @s reload_sr 35

execute if score #punch id matches 1 if score @s reload_sr matches 33 run scoreboard players set @s reload_sr 20
