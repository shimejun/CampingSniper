...
execute if score @s sneak matches ..9 unless block ~ ~1.5 ~ #owgame:noblock anchored eyes positioned ^ ^ ^1 run playsound minecraft:entity.generic.explode block @a[distance=..50] ~ ~ ~ 1 1 0.2
execute if score @s sneak matches 10.. unless block ~ ~0.5 ~ #owgame:noblock anchored eyes positioned ^ ^ ^1 run playsound minecraft:entity.generic.explode block @a[distance=..50] ~ ~ ~ 1 1 0.2

execute if block ~ ~1.5 ~ #owgame:noblock anchored eyes positioned ^ ^ ^1 as @a[distance=..7,tag=!shoot] at @s run playsound minecraft:entity.generic.explode block @s ~ ~ ~ 0.1 1
execute if block ~ ~0.5 ~ #owgame:noblock anchored eyes positioned ^ ^ ^1 as @a[distance=..7,tag=!shoot] at @s run playsound minecraft:entity.generic.explode block @s ~ ~ ~ 0.1 1
