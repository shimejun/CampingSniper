...
execute if block ~ ~1.5 ~ #owgame:noblock anchored eyes positioned ^ ^ ^1 as @a[distance=..7,tag=!shoot] at @s run playsound minecraft:entity.iron_golem.attack block @s ~ ~ ~ 4 2 4
execute if block ~ ~0.5 ~ #owgame:noblock anchored eyes positioned ^ ^ ^1 as @a[distance=..7,tag=!shoot] at @s run playsound minecraft:entity.iron_golem.attack block @s ~ ~ ~ 4 2 4
